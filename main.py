...
def train(model, optimizer, train_loader, test_loader):
    ...
    for e in range(args.nepoch):
        ...
        print(
            f"Epoch: [{e}/{args.nepoch}], loss:{total_loss / len(train_loader):.4f}, train_acc: {acc_train:.2f}, test_acc: {float(correct) * 100 / total:.2f}"
        )
...
if __name__ == "__main__":
    ...
    train_loader, test_loader = preprocess.load(
